= gitview - Summary information and stats on a local git repository

== Introduction

Sometimes it's nice to see a terminal screen's worth of stats about a 
git repo without having to type a bunch of git commands or even look up
specifics about said git commands. gitview was created to scratch this
particular itch (and also help me learn about making my own Gems). Hopefully,
...
?? README.rdocRepo status: Current

Total number of files: 11

Repo user name: Rick Crelia
Repo user email: rcrelia@gmail.com
...
Total number of commits: 4
  ...
  Newest commit on: 2014-12-08 13:26:40 -0800
